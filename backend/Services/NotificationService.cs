    ...
    public class NotificationService
    {
        ...
        public async Task SendAppointmentNotification(int appointmentId, string newStatus)
        {
            try
            {
                ...
                {
                    "Approved" => $"Good news! Your appointment {appointmentId} with Dr. {appointment.DoctorName} has been approved.",
                    "Rejected" => $"Your appointment {appointmentId} has been rejected. Please contact the hospital for more information.",
