    ...
    <div className="flex items-center justify-center min-h-screen bg-white/50 backdrop-blur-sm">
      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md text-center">
        ...
        <div className="flex gap-4 justify-center mt-6">
          ...
          <button
            onClick={() => navigate(-1)} 
            className="px-6 py-2 bg-gray-300 hover:bg-gray-400 text-gray-800 rounded-lg transition cursor-pointer"
          >
            Cancel
          </button>
          ...
          <button
            ...
            className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition cursor-pointer"
          >
            Logout
          </button>
