...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="pt-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                BloodLine is a cloud-based blood bank management system that
                bridges the gap between donors, patients, and hospitals during
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform leverages cutting-edge cloud technology to ensure
              blood availability when it matters most.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Instantly connect donors with patients in need through our cloud-powered platform.",
              },
              {
                icon: <Shield className="w-7 h-7 text-red-600" />,
                title: "Secure & Compliant",
                desc: "Your data is protected with enterprise-grade security and HIPAA compliance.",
              },
              {
                icon: <Activity className="w-7 h-7 text-red-600" />,
                title: "Live Inventory",
                desc: "Track blood stock levels in real-time across all connected hospitals.",
              },
              {
                icon: <Users className="w-7 h-7 text-red-600" />,
                title: "Multi-Role Access",
                desc: "Seamless experience for donors, patients, hospitals, and administrators.",
              },
            ].map((feature, index) => (
              <div
                key={index}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Create your account and complete your profile with blood type
                and location.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our system automatically matches donors with patients based on
                compatibility.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Receive notifications and coordinate with hospitals to donate
                blood.
              </p>
            </div>
          </div>
      ...
      <section
        id="about"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-50 to-white"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Whether you're a donor wanting to help, a patient in need, or a
                hospital managing inventory, BloodLine has you covered.
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                  ...
                  <p className="text-sm text-green-700">
                    Register, donate, track history, receive urgent alerts
                  </p>
                </div>
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-700">
                    Request blood, track status, get notifications
                  </p>
                </div>
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                  ...
                  <p className="text-sm text-purple-700">
                    Manage inventory, approve requests, generate reports
                  </p>
                </div>
      ...
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-red-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-red-100 mb-8">
            Join thousands of donors, patients, and healthcare providers using
            BloodLine to save lives every day.
          </p>
          <button
            onClick={() => navigate("/register")}
