...
export default function DonorDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Donor Dashboarddd</h1>
        <p className="text-gray-600 mt-2">Welcome back, {user?.name}!</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div 
          onClick={() => navigate('/donor/completed-donations')}
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Important:</strong> You can donate blood every 3 months.
              Please ensure you meet the eligibility criteria before requesting
              to donate.
            </p>
          </div>
        </div>
